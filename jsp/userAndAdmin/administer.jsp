...
<div id="main_container">
	...
	<div class="header">
    <div class="logo"><a href="#"><img src="images/logo.gif" width="170px" alt="" title="" border="0" /></a></div>
    
    <div class="right_header">Welcome 这里改成管理员的name, <a href="#">Visit site</a> | <a href="#" class="messages">(3) Messages</a> | <a href="#" class="logout">Logout</a></div>
    ...
    <div class="left_content">
            ...
            <form>
            <input type="text" name="" class="search_input" value="Search" onclick="this.value=''" />
            ...
            <div class="sidebarmenu">
                ...
                <a class="menuitem submenuheader" href="">用户</a>
                <div class="submenu">
                    <ul>
                    <li><a href="">管理用户</a></li>
                    <li><a href="">已冻结用户</a></li>
                    <li><a href="">已启用用户</a></li>
                    <li><a href="">新建用户</a></li>
					<li><a href="">重置用户密码</a></li>
                    </ul>
                </div>
                <a class="menuitem submenuheader" href="" >新闻</a>
                <div class="submenu">
                    <ul>
                    <li><a href="">管理新闻</a></li>
                    <li><a href="">新建新闻</a></li>
                ...
                <a class="menuitem_green" href="">搜索</a>
            </div>
